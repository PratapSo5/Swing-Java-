// Write a swing program for simple calculator

import  java.awt.event.*;
import  javax.swing.*;
public class SEx8 extends JFrame implements ActionListener {
    JTextField tf;
    JButton b1,b2,b3,b4,b5,b6,b7,b8,b9,b0,ba,bs,bm,bd,br,result,clr;
    String first;
    int OP;
    public  SEx8(){
    tf=new JTextField();
